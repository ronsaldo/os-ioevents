...
msbuild OSIOEvents.sln /p:Configuration=Debug /p:Platform=%VS_PLATFORM%
msbuild OSIOEvents.sln /p:Configuration=RelWithDebInfo /p:Platform=%VS_PLATFORM%
msbuild OSIOEvents.sln /p:Configuration=Release /p:Platform=%VS_PLATFORM%
